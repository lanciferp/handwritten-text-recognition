...
if __name__ == "__main__":
    ...
    for column_dict in column_model_list:
        ...
        #     model_output_path = os.path.join(output_path, "Name", name_list[0])
        #     combined_csv_path = combine_files(model_output_path, name_list[0] + "_final.csv")
        #     name_final_path = combined_csv_path
        #
        #     model_output_path = os.path.join(output_path, "Name", name_list[1])
        ...
        #
        #     model_output_path = os.path.join(output_path, "Age", age_list[1])
